...
impl FPU {
    ...
    pub fn push(&mut self, val: F80) -> Result<(), ()> {
        ...
        self.status.assign_top(physical).unwrap();
        Ok(())
    }
    ...
    pub fn pop(&mut self) -> Result<(), ()> {
        ...
        self.status.assign_top((physical + 1) & 7).unwrap();
        Ok(())
    }
}
...
impl Emulator {
    ...
    */
    fn read_fpu_binary_op(&mut self) -> Result<(u8, Float, Float), ExecError> {
        ...
        debug_assert!(a.prec() == f80::SIGNIFICANT_BITS && b.prec() == f80::SIGNIFICANT_BITS);
        Ok((s, a, b))
    }
    ...
    */
    ...
    fn exec_cmovcc(&mut self) -> Result<(), ExecError> {
